...
function OnlineLearn(q0, b0, x, H0, H1, S_t0, S_n0, Rule_g,
     eta, absol)
...
function OnlineFunction(g, q0, PL_t, eta, absol)
    if g == "Uni"
        q1 = PL_t
...
function OnlineLearn_Comp(q0, b0, x, H0, H1, S_t0, S_n0, Rule_g,
    eta, absol)
